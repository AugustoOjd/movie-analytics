...
const addMovieData = () => __awaiter(void 0, void 0, void 0, function* () {
    for (let index = 0; index < movies.length; index++) {
        const element = movies[index];
        yield instace.createMovie(element.title, element.description, element.price, element.category, element.release, element.image, element.premium, element.duration, element.seasons);
    }
});
exports.addMovieData = addMovieData;
